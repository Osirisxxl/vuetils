...
var methods_withBeforeAfter = function withBeforeAfter(methodsToEnhance) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      _ref$onBeforeEach = _ref.onBeforeEach,
      onBeforeEach = _ref$onBeforeEach === void 0 ? function () {} : _ref$onBeforeEach,
      _ref$onAfterEach = _ref.onAfterEach,
      onAfterEach = _ref$onAfterEach === void 0 ? function () {} : _ref$onAfterEach;

  if (!methodsToEnhance || methodsToEnhance.length === 0) {
    return {};
  }

  return Object.entries(methodsToEnhance).reduce(function (enhancedMethods, _ref2) {
    var _ref3 = _slicedToArray(_ref2, 2),
        methodName = _ref3[0],
        method = _ref3[1];

    return _objectSpread({}, enhancedMethods, _defineProperty({}, methodName, function () {
      var _mapped = _asyncToGenerator(
      /*#__PURE__*/
      ...
      return function mapped() {
        return _mapped.apply(this, arguments);
      };
    }()));
  }, {});
};
...
var components_bemModifiers = function bemModifiers(blockOrElementName) {
  var modifiers = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return [blockOrElementName, Object.entries(modifiers).reduce(function (modifiers, _ref) {
    var _ref2 = _slicedToArray(_ref, 2),
        name = _ref2[0],
        value = _ref2[1];

    return _objectSpread({}, modifiers, _defineProperty({}, "".concat(blockOrElementName, "--").concat(toKebabCase(name)), !!value));
  }, {})];
};
...
/* harmony default export */ var src = ({
  install: function install(Vue) {
    Vue.prototype.$bemModifiers = components_bemModifiers;
  }
});
// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "withBeforeAfter", function() { return methods_withBeforeAfter; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "bemModifiers", function() { return components_bemModifiers; });
...
/******/ });
//# sourceMappingURL=vuetils.common.js.map